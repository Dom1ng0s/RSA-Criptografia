...
def codificar(mensagem):
    ...
    for caractere in mensagem:
        if caractere in alfabeto:
            ...
            mensagem_codificada.append(valor_codificado)
...
def desencriptar():
    ...
    decodificada = [modular(c, d, n) for c in criptografada]
    mensagem = decodificar(decodificada)
